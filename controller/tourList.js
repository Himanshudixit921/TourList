...
module.exports.show = async (req, res) => {
    const foundPlace = await Campground.findById(req.params.id).populate({
        path: 'reviews',
        populate: {
            path: 'owner',
        }
...
module.exports.update = async (req, res) => {
    ...
    if (req.body.deleteimg) {
        ...
        await UpdatedCampground.updateOne({ $pull: { image: { filename: { $in: req.body.deleteimg } } } });
    }
